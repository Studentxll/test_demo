...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="C:\\Users\\87161\\Desktop\\clipscore-main\\candidates3-Florence 2.json")

    parser.add_argument(
        '--image_dir',
        type=str,
        help='Directory of images, with the filenames as image ids.',
        default="C:\\Users\\87161\\Desktop\\clipscore-main\\captiion test-image1")
...
def main():
    ...
    image_feats = extract_all_images(
        image_paths, model, device, batch_size=1, num_workers=0)
